...
# sidebar
with st.sidebar:
    selected = option_menu('MedPred:Disease Prediction', [
        'Accuracy:96% ',
        'Disease Prediction',
        'Diabetes Prediction',
...
if selected == 'Diabetes Prediction':  # pagetitle
    ...
    if st.button("Diabetes test result"):
        ...
        if diabetes_prediction[0] == 1:
            ...
            image = Image.open('img/positive.jpg')
            st.image(image, caption='')
        else:
            diabetes_dig = 'Congratulation,You are not diabetic'
            image = Image.open('img/negative.jpg')
            st.image(image, caption='')
...
if selected == 'Heart disease Prediction':
    ...
    image = Image.open('img/heart2.jpg')
